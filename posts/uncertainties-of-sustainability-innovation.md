...
To look at categories of climate impact, “Our World in Data” charts global greenhouse gas (GHG) emissions by sector, 
[discussion](https://ourworldindata.org/emissions-by-sector) and
...
•	Perhaps the uncertainties around progress are adaptation programmatic.  Where does government-private sector partnership fit? Who will fund this capability? What are the commercial framework for extracting sufficient "value" from the scale of measurement and processing needed - to what degree are "adaptation" services a public good?
